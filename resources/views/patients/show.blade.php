  ...
  <div class="row">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <span class="user-avatar pull-left" style="margin-right:8px; margin-top:-5px;">
                                        <img src="{{$patient->avatar}}" class="img-responsive img-circle" title="{{$patient->name}}" alt="{{$patient->name}}" width="30px" height="30px">
                                    </span>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="navbar-content">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <img src="{{$patient->avatar}}" alt="Alternate Text" class="img-responsive" width="120px" height="120px" />
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Earth</p>
                            <hr>
                            <h3><strong>Caregiver</strong></h3>
                            <?php $connections = \App\Connections::where('caregiver_id', $patient->id);?>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">{{$patient->name}} <small>{{$patient->email}}</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="{{$patient->name}} is sharing with you"></i></h1>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="pull-left">
                        <a href="#">
                            <img class="media-object img-circle" src="{{$patient->avatar}}" width="50px" height="50px" style="margin-right:8px; margin-top:-5px;">
                        </a>
                    </div>
                    <h4><a href="#" style="text-decoration:none;"><strong>{{$patient->name}}</strong></a> – <small><small><a href="#" style="text-decoration:none; color:grey;"><i><i class="fa fa-clock-o" aria-hidden="true"></i> 42 minutes ago</i></a></small></small></h4>
                    <span>
                    ...
                    <div class="post-content">
                        <h2>Location change</h2>
                        <iframe style="width:100%;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39398.62447043117!2d-2.1174930147402264!3d51.88990797614469!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48710338502e34ab%3A0xd067bca541f9e020!2sCheltenham%2C%20UK!5e0!3m2!1sen!2sae!4v1601201395885!5m2!1sen!2sae" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                    <hr>
                    <div>
                        ...
                        <div class="pull-left">
                              <p class="text-muted" style="margin-left:5px;"><i class="fa fa-user-secret" aria-hidden="true"></i> Only {{$patient->name}}'s Caregivers can see this</p><!--<p class="text-muted" style="margin-left:5px;"><i class="fa fa-globe" aria-hidden="true"></i> Public</p>-->
                        </div>
                        <br>
                    </div>
                    <hr>
                    <div class="media">
                        <div class="pull-left">
                            <a href="#">
                                <img class="media-object img-circle" src="{{$patient->avatar}}" width="35px" height="35px" style="margin-left:3px; margin-right:-5px;">
                            </a>
                        </div>
                        <div class="media-body">
