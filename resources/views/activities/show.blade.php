                ...
                <div class="panel-body">
                    <div class="media">
                        <div align="center">
                            ...
                            <img class="thumbnail img-responsive" src="{{$patient->avatar}}" width="300px" height="300px">
                            <p>{{$patient->name}}
                        </div>
                        <div class="media-body">
                            ...
                            <p>{{$activity->type}}</p>
                            <hr>
                            @if($activity->type == "Location Change")
                              <h3><strong>Where are they?</strong></h3>
                              <iframe style="width:100%;" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q={{urlencode($activity->value)}}&key=AIzaSyC6lQRaUlSOp1_RvysJHblIyMuVcgjXYvg" allowfullscreen></iframe>                             <hr>
                            @else
